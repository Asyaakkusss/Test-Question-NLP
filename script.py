...
wordcloud2010 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2010)
wordcloud2011 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2011)
wordcloud2012 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2012)
wordcloud2013 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2013)
wordcloud2014 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2014)
wordcloud2015 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2015)
wordcloud2016 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2016)
wordcloud2017 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2017)
wordcloud2018 = WordCloud(width=400, height=400, background_color = "pink").generate(data_2018)
